...
function initAll () 
{
    ...
    $.ajax({
        ...
        for(var i in data) 
        {
            ...
            compons_html += "</p>";
            compons_html += "<p class='foo'><span class='combo-left unused-compon'><i class='icon-time'></i> "+data[i].combo_left_day+"일</span><span class='compon-code'>콤템번호 : "+data[i].coupon_code+"</span>";
            compons_html += "</p>";            
